...
6. Pattern token* 
7. Category/Recognition response (1-3 training, 1 = old 2 = new recognition)
8. Correct/Incorrect (0 = Incorrect, 1 = Correct)
9. Reaction time (in milliseconds)
10-27.Coordinates of nine dots* (-25 - 24)

*Pattern token: index of unique tokens for each category of each type of patterns.The numbering of old medium pattern differs across the two conditions.
